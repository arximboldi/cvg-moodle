<?PHP // $Id: quiz.php,v 1.83.2.14 2009/06/05 06:54:35 tjhunt Exp $
...
$string['addipbased'] = 'Add $a IP based questions with function';
$string['addipbased1'] = '<< Add';
$string['addipbased2'] = 'IP based questions';
...
$string['requireuseragent'] = 'Require user-agent';
...
$string['useragenterror'] = 'Sorry, this quiz has been locked so that it is only accessible from certain locations.  Currently your computer is not one of those allowed to use this quiz.';
...
$string['useragentnotice'] = 'This quiz has been locked so that it is only accessible from certain locations. Your computer is not on an allowed subnet. As teacher you are allowed to preview anyway.';
